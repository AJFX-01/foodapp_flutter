...
class AppColors {
  static final Color textColor = const Color.fromARGB(255, 109, 218, 226);
  static final Color mainColor = Color.fromARGB(255, 233, 94, 103);
  ...
  static final Color mainBlackColor = Color.fromARGB(255, 56, 44, 40);
